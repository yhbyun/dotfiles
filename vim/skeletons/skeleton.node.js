...
<html lang="en">
  ...
  <title>dotfiles/vim/skeletons/skeleton.node.js at master · pgilad/dotfiles · GitHub</title>
  ...
  <meta name="request-id" content="9010:8827:281B5:43BAA:59B4DC6F" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="9010:8827:281B5:43BAA:59B4DC6F" name="octolytics-dimension-request_id" /><meta content="sea" name="octolytics-dimension-region_edge" /><meta content="iad" name="octolytics-dimension-region_render" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/blame" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="">
    ...
    <meta name="js-proxy-site-detection-payload" content="Njc1MDY1MmNkOTVhNGJiZTEzYjFlZGVlZmNmNjVlNzYyZmMxMGI0NDc1NjU5ZmEzMDVlZmFjYTgwMjMzNDQzMXx7InJlbW90ZV9hZGRyZXNzIjoiMTE0LjIwNC4xMS41NyIsInJlcXVlc3RfaWQiOiI5MDEwOjg4Mjc6MjgxQjU6NDNCQUE6NTlCNERDNkYiLCJ0aW1lc3RhbXAiOjE1MDUwMjUxMzUsImhvc3QiOiJnaXRodWIuY29tIn0=">


  <meta name="html-safe-nonce" content="9e13dc7746e3e268d1c49145537fa40f022891a7">
...
<meta name="theme-color" content="#1e2327">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/pgilad/dotfiles/search" class="js-site-search-form" data-scoped-search-url="/pgilad/dotfiles/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/pgilad/dotfiles/blame/master/vim/skeletons/skeleton.node.js" class="header-search-scope no-underline">This repository</a>
      <input type="text"
        ...
        <span class="d-inline-block">
            <div class="HeaderNavlink px-0 py-2 m-0">
              <a class="text-bold text-white no-underline" href="/login?return_to=%2Fpgilad%2Fdotfiles%2Fblame%2Fmaster%2Fvim%2Fskeletons%2Fskeleton.node.js" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
  ...
  <div class="file">
    <div class="file-header">
      <div class="file-actions">
        <div class="BtnGroup">
          <a href="/pgilad/dotfiles/raw/master/vim/skeletons/skeleton.node.js" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
          <a href="/pgilad/dotfiles/blob/master/vim/skeletons/skeleton.node.js" class="btn btn-sm js-update-url-with-hash BtnGroup-item">Normal view</a>
          <a href="/pgilad/dotfiles/commits/master/vim/skeletons/skeleton.node.js" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
        </div>
      </div>
    ...
    <div class="blob-wrapper">
      <table class="blame-container highlight data js-file-line-container tab-size" data-tab-size="4">
          <tbody class="blame-hunk">
            <tr class="blame-commit">
              <td class="blame-commit-info" rowspan="4">
                <span class="blame-commit-date" data-heat="10"><time-ago datetime="2014-05-18T19:05:40Z">May 18, 2014</time-ago></span>
                <a href="/pgilad" aria-label="pgilad" class="tooltipped tooltipped-e">
                  <img alt="@pgilad" class="avatar blame-commit-avatar" height="16" src="https://avatars2.githubusercontent.com/u/4533329?v=4&amp;s=32" width="16" />
                    ...
                    <a href="/pgilad/dotfiles/commit/4b6bd246b21a027e73c43ac2cbb56b2826095ae2" class="message" data-pjax="true" title="minor">minor</a>
                </span>
              </td>
              ...
              <tr class="blame-line">
                ...
                <td class="blob-code blob-code-inner js-file-line" id="LC1"><span class="pl-c1">module</span>.<span class="pl-en">exports</span> <span class="pl-k">=</span> <span class="pl-k">function</span>() {</td>
              </tr>
              <tr class="blame-line">
                <td class="line-age heat" data-heat="10"></td>
                <td class="blob-num blame-blob-num js-line-number" id="L2">2</td>
                <td class="blob-code blob-code-inner js-file-line" id="LC2">    $0</td>
              </tr>
              <tr class="blame-line">
                <td class="line-age heat" data-heat="10"></td>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between py-6 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2017 <span title="0.10810s from unicorn-3036445452-k8q77">GitHub</span>, Inc.</li>
